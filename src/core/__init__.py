...
class RabbitMQConfig:
    ...
    _rabbitmq_port = int(os.getenv("RABBITMQ_PORT", "5672"))
...
class RabbitMQURLConfig:
    ...
    """
    _rabbitmq_url: str = f"amqp://{RabbitMQConfig._rabbitmq_user}:{RabbitMQConfig._rabbitmq_password}@{RabbitMQConfig._rabbitmq_host}:{RabbitMQConfig._rabbitmq_port}"
